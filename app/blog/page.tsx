...
export default function Blog() {
    ...
    return (
        <div className="pt-20">
                        ...
                        {posts.map((post) => (
                            <Link key={post.slug} href={`/blog/${post.slug}`}>
                                <Card className="h-full flex flex-col hover:shadow-2xl transition-shadow duration-300">
                                    <div className="inline-block bg-spiritual-indigo-100 text-spiritual-indigo-700 px-3 py-1 rounded-full text-xs font-semibold mb-3 self-start">
                                        {post.category}
                                    </div>

                                    <h2 className="text-2xl font-bold text-spiritual-indigo-900 mb-3 line-clamp-2">
                                        {post.title}
                                    </h2>
                                    ...
                                    <div className="flex items-center justify-between text-sm text-gray-500 pt-4 border-t">
                                        <div className="flex items-center space-x-2">
                                            <div className="w-8 h-8 rounded-full bg-spiritual-indigo-600 flex items-center justify-center text-white text-xs font-bold">
            ...
            {/* Newsletter CTA */}
            <SectionWrapper className="bg-gradient-to-br from-spiritual-indigo-900 to-spiritual-indigo-800 text-white text-center">
                <div className="max-w-3xl mx-auto">
                    <h2 className="text-4xl font-bold mb-4">Stay Updated</h2>
                    <p className="text-xl text-spiritual-indigo-200 mb-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-lg mx-auto">
                        <input
                            ...
                            className="flex-1 px-6 py-3 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-spiritual-gold-500"
                        />
