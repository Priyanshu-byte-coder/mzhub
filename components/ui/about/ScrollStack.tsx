...
export const ScrollStackItem = ({ children, itemClassName = '' }: { children: React.ReactNode, itemClassName?: string }) => (
  <div
    className={`scroll-stack-card relative w-full max-w-3xl mx-auto min-h-[400px] h-auto my-8 p-8 md:p-10 rounded-[32px] shadow-[0_0_30px_rgba(0,0,0,0.1)] box-border origin-top will-change-transform overflow-hidden ${itemClassName}`.trim()}
    style={{
...
const ScrollStack = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      if (hasChanged) {
        ...
        (card as HTMLElement).style.webkitTransform = transform;
  ...
  return (
    <div className={containerClassName} ref={scrollerRef} style={containerStyles}>
      <div className="scroll-stack-inner pt-[15vh] px-4 md:px-8 pb-[20rem] min-h-screen">
        {children}
