                ...
                <div className="space-y-10 sm:space-y-16">
                    <div className="space-y-4 sm:space-y-6 text-left">
                        ...
                        <motion.h2
                            ...
                            viewport={{ once: true }}
                            className="text-[2rem] xs:text-[2.4rem] sm:text-[2.8rem] md:text-[clamp(2.6rem,6vw,5.8rem)] font-semibold uppercase tracking-[0.12em] sm:tracking-[0.22em] leading-tight break-words text-spiritual-indigo-600 dark:text-white text-left"
                    ...
                    <div className="lg:grid lg:grid-cols-[0.8fr_1.2fr_0.9fr] gap-10 lg:gap-16 items-start">
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className="rounded-[24px] border border-[#DFE3E9] bg-gradient-to-r from-[#f0f4ff] via-[#FDFBFF] to-[#e0e7ff] px-8 py-6 text-center shadow-lg dark:border-white/15 dark:bg-gradient-to-r dark:from-white/15 dark:via-white/5 dark:to-white/15 dark:shadow-none"
                            >
